...
public class AsyncLogin extends AsyncTask<Void, Void, Void> {
    ...
    String uriString = null;    // URI文字列
    String user = null;         // ログイン名
    ...
    public AsyncLogin(Context context, String uriString, String user,
    ...
    /*
     * 下記を参考にしました: HttpClient Tutorial - Chapter 4. HTTP authentication
     * http://hc
     * .apache.org/httpcomponents-client-ga/tutorial/html/authentication.html
     */
    @Override
